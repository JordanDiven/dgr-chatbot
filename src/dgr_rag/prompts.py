...
PRESCRIPTION_PROMPT = (
    ...
    "Scale plan complexity to the user's training familiarity from intake.\n"
    "If low familiarity, prescribe the bare minimum and keep it simple.\n"
    "If high familiarity, you can include more complex progressions.\n"
    "Output format:\n"
